      ...
      tasks = await Task.create([
        {
          ...
          userId: filter.userId as any,
          tenantId,
        },
        {
          title: "Implement idle detection",
        ...
        {
          title: "Fix screenshot upload issue",
        ...
        {
          title: "Integrate notification center",
...
const createTask = async (
  ...
  try {
    ...
    const targetUserId =
      req.user?.role === "employee" ? req.user._id : userId || req.user?._id;
